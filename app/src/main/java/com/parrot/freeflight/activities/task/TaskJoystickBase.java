...
public abstract class TaskJoystickBase extends Sprite
{
	...
	protected TaskJoystickListener analogueListener;
	...
	public TaskJoystickBase(final Context context, Align align, boolean absolute)
	{
		super(align);
...
//        }
	...
	public void setOnAnalogueChangedListener(TaskJoystickListener listener)
	{
