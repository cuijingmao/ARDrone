...
public class FirmVideoStageRenderer implements Renderer {
   ...
   //added by cui
	...
	public FirmVideoStageRenderer(Context context, Bitmap initialTexture)
	{
	...
	public void onDrawFrame(Canvas canvas)
	{
		 ...
		 */
		//added by cui
       canvas.setBitmap(bitmap);//将canvas的图像保存为bitmap
