...
public class PathHudViewController
    ...
    private PathVideoStageView canvasView;
    ...
    public PathHudViewController(Activity context, boolean useSoftwareRendering) {
        joypadOpacity = 1f;
         ...
         * 此处  控制了FirmActivity的界面
         */
        renderer = new PathVideoStageRenderer(context, null);  //render 执行真正的渲染工作
...
//			root.removeView(glView);
            ...
            canvasView = new PathVideoStageView(context);
