...
public class BallConnectActivity
        ...
        implements ServiceConnection, DroneReadyReceiverDelegate, DroneConnectionChangeReceiverDelegate
{
    ...
    private static final String TAG = BallConnectActivity.class.getSimpleName();
    ...
    private void prepareGoogleTVControls()
    {
        ...
        autoSkipCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            ...
            {
               BallConnectActivity.this.setAutoSkip(isChecked);
            }
        });
    }
    ...
    {
        Intent ballActivity = new Intent(BallConnectActivity.this,BallActivity.class);
        ballActivity.putExtra("USE_SOFTWARE_RENDERING", false);
        ballActivity.putExtra("FORCE_COMBINED_CONTROL_MODE", false);
