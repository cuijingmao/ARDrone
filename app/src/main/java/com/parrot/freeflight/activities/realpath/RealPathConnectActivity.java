...
public class RealPathConnectActivity
    ...
    private static final String TAG = RealPathConnectActivity.class.getSimpleName();
    ...
    private void prepareGoogleTVControls() {
        ...
        autoSkipCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
               RealPathConnectActivity.this.setAutoSkip(isChecked);
            }
        });
    }
    ...
    private void onOpenHudScreen() {
        Intent realPathActivity = new Intent(RealPathConnectActivity.this,RealPathActivity.class);
        realPathActivity.putExtra("USE_SOFTWARE_RENDERING", false);
        realPathActivity.putExtra("FORCE_COMBINED_CONTROL_MODE", false);
        startActivity(realPathActivity);
    }
