...
public class RealPathVideoStageView extends SurfaceView
implements 
	SurfaceHolder.Callback
{
	...
	private RealPathVideoStageRenderer renderer;
	private int width = 0;
	...
	public RealPathVideoStageView(Context context) {
		super(context);
...
//		Specify a bitmap for the canvas to draw into.
	...
	public void setRenderer(RealPathVideoStageRenderer renderer)
	{
    ...
    class DrawThread extends Thread {
        ...
        private RealPathVideoStageView view;
        private boolean run = false;

        public DrawThread(SurfaceHolder surfaceHolder,RealPathVideoStageView gameView) {
