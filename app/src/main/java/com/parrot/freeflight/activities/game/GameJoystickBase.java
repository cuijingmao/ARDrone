...
public abstract class GameJoystickBase extends Sprite
{
	...
	protected GameJoystickListener analogueListener;
	...
	public GameJoystickBase(final Context context, Align align, boolean absolute)
	{
		super(align);
...
//        }
	...
	public void setOnAnalogueChangedListener(GameJoystickListener listener)
	{
