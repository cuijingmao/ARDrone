...
public class BallHudViewController
			   ...
			   OnGestureListener
{
	...
	private BallJoystickBase[] joysticks;
	...
	public BallHudViewController(Activity context, boolean useSoftwareRendering)
	{
	    joypadOpacity = 1f;
		...
		canvasView = null;
		joysticks = new BallJoystickBase[2];
...
//
	...
	public void setJoysticks(BallJoystickBase left, BallJoystickBase right)
	{
		joysticks[0] = left;
		if (left != null)   {
		...
		for (int i=0; i<joysticks.length; ++i) {
		    BallJoystickBase joystick = joysticks[i];
	...
	public BallJoystickBase getJoystickLeft()
	{
	    return joysticks[0];
	}
	
	
	public BallJoystickBase getJoystickRight()
	{
	    return joysticks[1];
	}
	...
	public boolean onTouch(View v, MotionEvent event)
	{
		...
		if (result != true) {	
			...
			for (int i=0; i<joysticks.length; ++i) {
				BallJoystickBase joy = joysticks[i];
				if (joy != null) {
