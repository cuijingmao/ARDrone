...
public class TaskConnectActivity
        ...
        implements ServiceConnection, DroneReadyReceiverDelegate, DroneConnectionChangeReceiverDelegate
{
    ...
    private static final String TAG = TaskConnectActivity.class.getSimpleName();
  ...
  ImageView imageView;
    ...
    private void prepareGoogleTVControls()
    {
        ...
        autoSkipCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            ...
            {
               TaskConnectActivity.this.setAutoSkip(isChecked);
            }
        });
    }
    ...
    {
        Intent gameActivity = new Intent(TaskConnectActivity.this,TaskActivity.class);
        gameActivity.putExtra("USE_SOFTWARE_RENDERING", false);
        gameActivity.putExtra("FORCE_COMBINED_CONTROL_MODE", false);
