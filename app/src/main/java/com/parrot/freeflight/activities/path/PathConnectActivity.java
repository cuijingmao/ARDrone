...
public class PathConnectActivity
    ...
    private static final String TAG = PathConnectActivity.class.getSimpleName();
    ...
    private void prepareGoogleTVControls() {
        ...
        autoSkipCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                PathConnectActivity.this.setAutoSkip(isChecked);
            }
        });
    }
    ...
    private void onOpenHudScreen() {
        Intent firmActivity = new Intent(PathConnectActivity.this,PathActivity.class);
