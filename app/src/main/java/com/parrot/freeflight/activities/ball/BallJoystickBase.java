...
public abstract class BallJoystickBase extends Sprite
{
	...
	protected BallJoystickListener analogueListener;
	...
	public BallJoystickBase(final Context context, Align align, boolean absolute)
	{
		super(align);
...
//        }
	...
	public void setOnAnalogueChangedListener(BallJoystickListener listener)
	{
