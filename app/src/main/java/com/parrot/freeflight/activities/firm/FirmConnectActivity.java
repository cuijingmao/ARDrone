...
import com.parrot.freeflight.activities.game.GameActivity;
...
public class FirmConnectActivity
    ...
    private static final String TAG = FirmConnectActivity.class.getSimpleName();
    ...
    private void prepareGoogleTVControls() {
        ...
        autoSkipCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                FirmConnectActivity.this.setAutoSkip(isChecked);
            }
        });
    }
    ...
    private void onOpenHudScreen() {
        Intent firmActivity = new Intent(FirmConnectActivity.this,FirmActivity.class);
        firmActivity.putExtra("USE_SOFTWARE_RENDERING", false);
        firmActivity.putExtra("FORCE_COMBINED_CONTROL_MODE", false);
        startActivity(firmActivity);
    }
