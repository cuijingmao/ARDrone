...
public class PathVideoStageView extends SurfaceView
implements 
	SurfaceHolder.Callback
{
	...
	private PathVideoStageRenderer renderer;
	private int width = 0;
	...
	public PathVideoStageView(Context context) {
		super(context);
...
//		Specify a bitmap for the canvas to draw into.
	...
	public void setRenderer(PathVideoStageRenderer renderer)
	{
    ...
    class DrawThread extends Thread {
        ...
        private PathVideoStageView view;
        private boolean run = false;

        public DrawThread(SurfaceHolder surfaceHolder, PathVideoStageView gameView) {
