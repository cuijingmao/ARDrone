...
public class FirmVideoStageView extends SurfaceView
implements 
	SurfaceHolder.Callback
{
	...
	private FirmVideoStageRenderer renderer;
	private int width = 0;
	private int height = 0;
	private DrawThread invalidateThread;
	Bitmap videoBitmap;//added by cui
	Paint fpsPaint = new Paint();
	
	public FirmVideoStageView(Context context) {
		super(context);	
...
//		Specify a bitmap for the canvas to draw into.
	    canvas.setBitmap(videoBitmap);
		videoBitmap= ImageProcessor.convertToBlackWhite(videoBitmap, ColorType.RED);
		canvas=new Canvas(videoBitmap);
		//added by cui
		if (renderer != null) {
	...
	public void setRenderer(FirmVideoStageRenderer renderer)
	{
    ...
    class DrawThread extends Thread {
        ...
        private FirmVideoStageView view;
        private boolean run = false;

        public DrawThread(SurfaceHolder surfaceHolder, FirmVideoStageView gameView) {
