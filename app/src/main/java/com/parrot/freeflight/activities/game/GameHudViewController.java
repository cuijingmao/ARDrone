...
public class GameHudViewController
...
//	private TextView txtVideoFps;
	...
	private GameJoystickBase[] joysticks;
	...
	public GameHudViewController(Activity context, boolean useSoftwareRendering)
	{
	    joypadOpacity = 1f;
		...
		canvasView = null;
		joysticks = new GameJoystickBase[2];
...
//
	...
	public void setJoysticks(GameJoystickBase left, GameJoystickBase right)
	{
		joysticks[0] = left;
		if (left != null)   {
		...
		for (int i=0; i<joysticks.length; ++i) {
		    GameJoystickBase joystick = joysticks[i];
	...
	public GameJoystickBase getJoystickLeft()
	{
	    return joysticks[0];
	}
	
	
	public GameJoystickBase getJoystickRight()
	{
	    return joysticks[1];
	}
	...
	public boolean onTouch(View v, MotionEvent event)
	{
		...
		if (result != true) {	
			...
			for (int i=0; i<joysticks.length; ++i) {
				GameJoystickBase joy = joysticks[i];
				if (joy != null) {
