...
public class RealPathHudViewController
    ...
    private RealPathVideoStageView canvasView;
    ...
    public RealPathHudViewController(Activity context, boolean useSoftwareRendering) {
        joypadOpacity = 1f;
         ...
         * 此处  控制了FirmActivity的界面
         */
        renderer = new RealPathVideoStageRenderer(context, null);  //render 执行真正的渲染工作
...
//			root.removeView(glView);
            ...
            canvasView = new RealPathVideoStageView(context);
