...
public class GameConnectActivity
...
//        }
    ...
    private void prepareGoogleTVControls()
    {
        ...
        autoSkipCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            ...
            {
                GameConnectActivity.this.setAutoSkip(isChecked);
            }
        });
    }
    ...
    {
        Intent gameActivity = new Intent(GameConnectActivity.this, GameActivity.class);
